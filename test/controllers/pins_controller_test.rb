...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { address: @pin.address, lat: @pin.lat, lng: @pin.lng, name: @pin.name } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { address: @pin.address, lat: @pin.lat, lng: @pin.lng, name: @pin.name } }
